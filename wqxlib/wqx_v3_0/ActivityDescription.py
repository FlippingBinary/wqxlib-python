...
class ActivityDescription:
  ...
  def __init__(self, o=None, *,
    ...
    if isinstance(o, ActivityDescription):
      ...
      self.activityBottomDepthHeightMeasure = o.get('activityBottomDepthHeightMeasure')
      self.activityDepthAltitudeReferencePointText = o.get('activityDepthAltitudeReferencePointText')
      self.projectIdentifier = o.get('projectIdentifier')
      self.activityConductingOrganizationText = o.get('activityConductingOrganizationText', [])
  ...
  def generateXML(self, name:str = 'ActivityDescription') -> str:
    ...
    with tag(name):
      ...
      if self.__activityDepthHeightMeasure is not None:
        asis(self.__activityDepthHeightMeasure.generateXML('ActivityDepthHeightMeasure'))
      if self.__activityTopDepthHeightMeasure is not None:
        asis(self.__activityTopDepthHeightMeasure.generateXML('ActivityTopDepthHeightMeasure'))
      if self.__activityBottomDepthHeightMeasure is not None:
        asis(self.__activityBottomDepthHeightMeasure.generateXML('ActivityBottomDepthHeightMeasure'))
