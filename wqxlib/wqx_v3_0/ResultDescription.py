...
class ResultDescription:
  ...
  def __init__(self, o=None, *,
    ...
    if isinstance(o, ResultDescription):
      ...
      self.proportionSampleProcessedNumeric = o.get('proportionSampleProcessedNumeric')
      ...
      self.resultDepthAltitudeReferencePointText = o.get('resultDepthAltitudeReferencePointText')
      self.resultSamplingPointName = o.get('resultSamplingPointName')
      self.resultSamplingPointType = o.get('resultSamplingPointType')
      self.resultSamplingPointPlaceInSeries = o.get('resultSamplingPointPlaceInSeries')
  ...
  def generateXML(self, name:str = 'ResultDescription') -> str:
    ...
    with tag(name):
      ...
      if self.__resultDepthHeightMeasure is not None:
        asis(self.__resultDepthHeightMeasure.generateXML('ResultDepthHeightMeasure'))
