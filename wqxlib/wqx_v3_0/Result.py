  ...
  def generateXML(self, name:str = 'Result') -> str:
    ...
    with tag(name):
      ...
      if self.__biologicalResultDescription is not None:
        asis(self.__biologicalResultDescription.generateXML('BiologicalResultDescription'))
      ...
      if self.__comparableAnalyticalMethod is not None:
        asis(self.__comparableAnalyticalMethod.generateXML('ComparableAnalyticalMethod'))
