...
class ProjectMonitoringLocationWeighting:
  ...
  def generateXML(self, name:str = 'ProjectMonitoringLocationWeighting') -> str:
    ...
    with tag(name):
      ...
      asis(self.__locationWeightingFactorMeasure.generateXML('LocationWeightingFactorMeasure'))
      ...
      if self.__referenceLocationCitation is not None:
        asis(self.__referenceLocationCitation.generateXML('ReferenceLocationCitation'))
